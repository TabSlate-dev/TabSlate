...
| `kv` | `key` | — | 键值对：`activeWorkspaceId`、`compactGroupTitles`、`localSeq`、`sync-leader`、`searchEngines`；以及 compact group 稳定标题条目 `compact-group-title:${color}:${firstChar}`（详见 Compact group title 注意事项） |
